...
//add contentType and add type check for _d9
$.ajax({type:_d5.method,url:_d5.url,contentType:_d5.contentType,data:_d3,dataType:"json",success:function(_d9){
...
function _47b(){
//modify by hexj,add contentType and useJosnStringData and json to String.2011-06-21
$.ajax({
type:opts.method,
url:opts.url,
data:opts.useJosnStringData?JSON.stringify(_47a):_47a,
dataType:"json",
...
url:opts.url,
contentType:opts.contentType,
data:opts.useJosnStringData?JSON.stringify(_59d):_59d,
dataType:"json",
success:function(data){
...
//edit by zjb  2012-03-02
//orignal:
//$.ajax({type:opts.method,url:opts.url,dataType:"json",data:_683,success:function(data){
// _67c(_682,data,_684);
//add:contentType:opts.contentType      eval(data)

$.ajax({type:opts.method,url:opts.url,contentType: opts.contentType,dataType:"json",data:_683,success:function(data){
_67c(_682,eval(data),_684);
},error:function(){
...
if(opts.mode=="remote"){
grid.datagrid("clearSelections");
if(typeof(warehouseno) != 'undefined')
{
q=warehouseno+":"+q;
}
