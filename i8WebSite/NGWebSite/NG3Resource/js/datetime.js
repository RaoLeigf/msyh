Ext.define('Ext.picker.DateTime', {
        ...
        renderTpl: [
            '<div id="{id}-innerEl" role="grid">',
                ...
                '</div>',
            '<table id="{id}-eventEl" class="{baseCls}-inner" cellspacing="0" style="height: 180px;" role="presentation">',
        ...
        onRender : function(container, position){
            ...
            me.textNodes = me.eventEl.query('tbody td a');//me.eventEl.query('tbody td span');
        ...
        createHoursPicker: function() {
            if (!this.hoursPicker.dom.firstChild) {
                ...
                for (var i = 0; i < 24; i += 4) {
                    hoursEl.push('<tr>' ,
                        '<td role = "gridcell"  class="x-datepicker-active" style="text-align:center;">',
                        '<a role="presentation" hidefocus="on" href="#" class="x-datepicker-date" >',
                        i,
                        "</a>" ,
                        "</td>",
                        '<td role = "gridcell"  class="x-datepicker-active" style="text-align:center;">',
        ...
        showHoursPicker: function() {
            ...
            this.hoursPicker.setStyle({zIndex:10});
        ...
        updateMPHour: function(a) {
            ...
            this.mpHours.each(function(b, c, d) {
                if (b.dom.xhour==a){
                    ...
                    b.dom.childNodes[0].setAttribute('style',"border: 1px solid #8DB2E3; font-weight: bold; background-color: #DAE5F3; ");
                }else{
                    b.removeCls("x-datepicker-selected");
                    //b.dom.childNodes[0].childNodes[0].childNodes[0].setAttribute('style','');
                    b.dom.childNodes[0].setAttribute('style','');
                }
            })
        },
        ...
        createMinutesPicker: function() {
            if (!this.minutesPicker.dom.firstChild) {
                ...
                a.push('<tr><td class="x-datepicker-header" align="center" style="text-align:center;"  colspan="6">', '<span style = "color:white!important;">','选择分钟', '</span>',"</td></tr>");
                for (var b = 0; b < 60; b += 6) {
                    a.push('<tr><td role = "gridcell" class="x-datepicker-active" style="text-align:center;" >',
                        '<a role="presentation" hidefocus="on" href="#" class="x-datepicker-date">',
                        b,
                        "</a></td>",
                        '<td role = "gridcell" class="x-datepicker-active" style="text-align:center" >',
        ...
        showMinutesPicker: function() {
            ...
            this.minutesPicker.setStyle({zIndex:10});
        ...
        createSecondsPicker: function() {
            if (!this.secondPicker.dom.firstChild) {
                var a = ['<table border="0" cellspacing="0">'];
                a.push('<tr><td class="x-datepicker-header" align="center" style="text-align:center;"  colspan="6">', '<span style = "color:white!important;">','选择秒钟', '</span>',"</td></tr>");
                for (var b = 0; b < 60; b += 6) {
                    a.push('<tr>',
                        '<td  class="x-datepicker-active " style="text-align:center;" >',
                        '<a role="presentation" hidefocus="on" href="#" class="x-datepicker-date" >',
                        b,
                        "</a></td>",
                        '<td  class="x-datepicker-active " style="text-align:center;" >',
        ...
        showSecondsPicker: function() {
            ...
            this.secondPicker.setStyle({zIndex:10});
        ...
        getValue : function(){
            if (this.stringDate){
                if (this.showTimer){
                    ...
                    return Ext.Date.format(this.value, "Y-m-d H:i:s")
                }else{
        ...
        selectedUpdate: function(date){
            ...
            for (c = 0; c < cLen; c++) {
                ...
                //if (cell.dom.firstChild.dateValue == t) {
                 if (cell.dom.firstChild.dateValue == curselectedDay) {
...
Ext.define('Ext.ng.DateTime', {
    extend: 'Ext.form.field.Picker',
    alias: 'widget.ngDateTime',
    ...
    */
    createPicker: function () {
        ...
        var p = Ext.create('Ext.picker.DateTime', {
            pickerField: me,
            stringDate: me.stringDate,
            showTimer: me.showTimer,
            ownerCt: me.ownerCt,
    ...
    */
    ...
    safeParse: function (value, format) {
        ...
        if (utilDate.formatContainsHourInfo(format)) {
            ...
            //utilDate.parse(value + ' ' + me.initTime, format + ' ' + me.initTimeFormat);
    ...
    getModelData: function () {
        var val = {};
        val[this.name] = this.getRawValue();
        return val;
    },
