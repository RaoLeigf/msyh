//合同决算弹出帮助字段-单选
Ext.define('Ext.cnt.FinalHelpField', {
    extend: 'Ext.ng.RichHelp',
    alias: 'widget.FinalHelpField',
    helpid: 'pcm3.pcm3_cnt_final',
    valueField: 'PhId',
    displayField: 'BillNo',
    editable: false,
    cntmodel: 0,
    ...
    onTriggerClick: function () {
        ...
        var help = Ext.create('Ext.cnt.FinalHelpWindow', { cntmodel: me.cntmodel });
