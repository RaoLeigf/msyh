...
Ext.onReady(function() {
    ...
    if (Ext.DateTime) {
        Ext.DateTime.monthNames = ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"];

        Ext.DateTime.dayNames = ["星期日", "星期一", "星期二", "星期三", "星期四", "星期五", "星期六"];

        Ext.DateTime.formatCodes.a = "(this.getHours() < 12 ? '上午' : '下午')";
        Ext.DateTime.formatCodes.A = "(this.getHours() < 12 ? '上午' : '下午')";
        ...
        Ext.DateTime.parseCodes.a = Ext.Date.parseCodes.A = parseCodes;
    }
...
Ext.define("Ext..locale.zh_CN.grid.feature.Grouping", {	
