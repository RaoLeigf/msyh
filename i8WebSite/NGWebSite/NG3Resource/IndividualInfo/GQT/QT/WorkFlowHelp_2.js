        ...
        me.buttons = ['->', {
            ...
            handler: function () {
				...
				for(var i=0;i<resultStore.getCount();i++){
					...
					var data2='{"form":{"key":"PhId","newRow":{"Dwdm":"'+orgPhid+'","Dydm":"'+record.get('Dm')+'","Dylx":"08","DefStr1":"'+orgcode+'","PhId":"","NgRecordVer":"","key":""}}}';
					Ext.Ajax.request({
						params:{data:data2},
						url: C_ROOT + 'GQT/QT/CorrespondenceSettings2/SaveZCLB',
						success: function (response) {
							var resp = Ext.JSON.decode(response.responseText);
				...
				//var mydata = {};
				//var zjlydata = gridRight.getChangeForEntity();
				//var data1="{\"form\":{\"key\":\"PhId\",\"newRow\":{\"Dwdm\":\"Z\",\"Dydm\":\"Z\",\"PhId\":\"\",\"NgRecordVer\":\"\",\"key\":\"\"}}}";
				//var data2='{"form":{"key":"PhId","newRow":{"Dwdm":"vc","Dydm":"vc","PhId":"","NgRecordVer":"","key":""}}}';
				//myData = Ext.apply(mydata, { 'zjlydata': zjlydata});
				//Ext.Ajax.request({
                    //params:mydata,
					//params:{data:data2},
