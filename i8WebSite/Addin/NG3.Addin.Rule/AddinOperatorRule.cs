#region Summary
/**************************************************************************************
    * 类 名 称：        AddinOperatorRule
    * 命名空间：        NG3.Addin.Rule
    * 文 件 名：        AddinOperatorRule.cs
    * 创建时间：        2017/8/3 
    * 作    者：        韦忠吉    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// AddinOperator业务逻辑处理类
	/// </summary>
    public partial class AddinOperatorRule : EntRuleBase<AddinOperatorModel>, IAddinOperatorRule
    {
        #region 类变量及属性
		/// <summary>
        /// AddinOperator数据访问处理对象
        /// </summary>
        IAddinOperatorDac AddinOperatorDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IAddinOperatorDac;
            }
        }
        ...
        public override bool DataCheck(IList<AddinOperatorModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<AddinOperatorModel> entities, Int64 masterId)
        {
		...
		#region 实现 IAddinOperatorRule 业务添加的成员

		///// <summary>
        ///// 方法实例
        ///// </summary>
        ///// <returns></returns>
        //public List<AddinOperatorModel> ExampleMethod<AddinOperatorModel>(string param)
        //{
        //    //编写代码
        //}
