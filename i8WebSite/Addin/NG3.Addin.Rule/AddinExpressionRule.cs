#region Summary
/**************************************************************************************
    * 类 名 称：        AddinExpressionRule
    * 命名空间：        NG3.Addin.Rule
    * 文 件 名：        AddinExpressionRule.cs
    * 创建时间：        2017/7/10 
    * 作    者：        韦忠吉    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// AddinExpression业务逻辑处理类
	/// </summary>
    public partial class AddinExpressionRule : EntRuleBase<AddinExpressionModel>, IAddinExpressionRule
    {
        #region 类变量及属性
		/// <summary>
        /// AddinExpression数据访问处理对象
        /// </summary>
        IAddinExpressionDac AddinExpressionDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IAddinExpressionDac;
            }
        }
        ...
        public override bool DataCheck(IList<AddinExpressionModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<AddinExpressionModel> entities, Int64 masterId)
        {
		...
		#region 实现 IAddinExpressionRule 业务添加的成员
