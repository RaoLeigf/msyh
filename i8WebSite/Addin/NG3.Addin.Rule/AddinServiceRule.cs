#region Summary
/**************************************************************************************
    * 类 名 称：        AddinServiceRule
    * 命名空间：        NG3.Addin.Rule
    * 文 件 名：        AddinServiceRule.cs
    * 创建时间：        2017/12/13 
    * 作    者：        洪鹏    
    * 说    明：        
---------------------------------------------------------------------------------------
...
namespace NG3.Addin.Rule
{
	...
	/// AddinService业务逻辑处理类
	/// </summary>
    public partial class AddinServiceRule : EntRuleBase<AddinServiceModel>, IAddinServiceRule
    {
        #region 类变量及属性
		/// <summary>
        /// AddinService数据访问处理对象
        /// </summary>
        IAddinServiceDac AddinServiceDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IAddinServiceDac;
            }
        }
        ...
        public override bool DataCheck(IList<AddinServiceModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<AddinServiceModel> entities, Int64 masterId)
        {
		...
		#region 实现 IAddinServiceRule 业务添加的成员
