#region Summary
/**************************************************************************************
    * 类 名 称：        ExtendFunctionMstRule
    * 命名空间：        NG3.Addin.Rule
    * 文 件 名：        ExtendFunctionMstRule.cs
    * 创建时间：        2017/7/10 
    * 作    者：        韦忠吉    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// ExtendFunctionMst业务逻辑处理类
	/// </summary>
    public partial class ExtendFunctionMstRule : EntRuleBase<ExtendFunctionMstModel>, IExtendFunctionMstRule
    {
        #region 类变量及属性
		/// <summary>
        /// ExtendFunctionMst数据访问处理对象
        /// </summary>
        IExtendFunctionMstDac ExtendFunctionMstDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IExtendFunctionMstDac;
            }
        }
        ...
        public override bool DataCheck(IList<ExtendFunctionMstModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<ExtendFunctionMstModel> entities, Int64 masterId)
        {
		...
		#region 实现 IExtendFunctionMstRule 业务添加的成员
