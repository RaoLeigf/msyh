#region Summary
/**************************************************************************************
    * 类 名 称：        AddinExpressionVarRule
    * 命名空间：        NG3.Addin.Rule
    * 文 件 名：        AddinExpressionVarRule.cs
    * 创建时间：        2017/7/10 
    * 作    者：        韦忠吉    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// AddinExpressionVar业务逻辑处理类
	/// </summary>
    public partial class AddinExpressionVarRule : EntRuleBase<AddinExpressionVarModel>, IAddinExpressionVarRule
    {
        #region 类变量及属性
		/// <summary>
        /// AddinExpressionVar数据访问处理对象
        /// </summary>
        IAddinExpressionVarDac AddinExpressionVarDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IAddinExpressionVarDac;
            }
        }
        ...
        public override bool DataCheck(IList<AddinExpressionVarModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<AddinExpressionVarModel> entities, Int64 masterId)
        {
		...
		#region 实现 IAddinExpressionVarRule 业务添加的成员
