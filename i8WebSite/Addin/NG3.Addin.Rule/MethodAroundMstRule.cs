#region Summary
/**************************************************************************************
    * 类 名 称：        MethodAroundMstRule
    * 命名空间：        NG3.Addin.Rule
    * 文 件 名：        MethodAroundMstRule.cs
    * 创建时间：        2017/7/10 
    * 作    者：        韦忠吉    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// MethodAroundMst业务逻辑处理类
	/// </summary>
    public partial class MethodAroundMstRule : EntRuleBase<MethodAroundMstModel>, IMethodAroundMstRule
    {
        #region 类变量及属性
		/// <summary>
        /// MethodAroundMst数据访问处理对象
        /// </summary>
        IMethodAroundMstDac MethodAroundMstDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IMethodAroundMstDac;
            }
        }
        ...
        public override bool DataCheck(IList<MethodAroundMstModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<MethodAroundMstModel> entities, Int64 masterId)
        {
		...
		#region 实现 IMethodAroundMstRule 业务添加的成员
