...
namespace NG3.Addin.Rule
{
	...
	/// AddinSql业务逻辑处理类
	/// </summary>
    public partial class AddinSqlRule : EntRuleBase<AddinSqlModel>, IAddinSqlRule
    {
        #region 类变量及属性
		/// <summary>
        /// AddinSql数据访问处理对象
        /// </summary>
        IAddinSqlDac AddinSqlDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IAddinSqlDac;
            }
        }
        ...
        public override bool DataCheck(IList<AddinSqlModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<AddinSqlModel> entities, Int64 masterId)
        {
		...
		#region 实现 IAddinSqlRule 业务添加的成员
