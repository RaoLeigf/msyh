#region Summary
/**************************************************************************************
    * 类 名 称：        IMethodAroundMstService
    * 命名空间：        NG3.Addin.Service.Interface
    * 文 件 名：        IMethodAroundMstService.cs
    * 创建时间：        2017/7/10 
    * 作    者：        韦忠吉    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// MethodAroundMst服务组装层接口
	/// </summary>
    public partial interface IMethodAroundMstService : IEntServiceBase<MethodAroundMstModel>
    {
        #region IMethodAroundMstService 业务添加的成员
