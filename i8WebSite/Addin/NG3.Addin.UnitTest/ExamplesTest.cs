...
/**************************************************************************************
    * 类 名 称：        ExamplesTest
    * 命名空间：        NG3.Addin.UnitTest
    * 文 件 名：        ExamplesTest.cs
    * 创建时间：        2017/7/10 14:12:28 
    * 作    者：        丰立新    
    * 说    明：        
---------------------------------------------------------------------------------------
    * 修改时间：        * 修改人：        *说明：
    ...
    public class ExamplesTest : AbstractTransactionalDbProviderSpringContextTests
    {
        ...
        protected IExamplesService ExamplesService
        {
            get
            {
                ...
                return applicationContext.GetObject<IExamplesService>("NG3.Addin.UnitTest.Service.ExamplesService");
            }
        }
