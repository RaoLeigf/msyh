...
{
    public partial class PageEditJsWithTabTemplate
    {
        ...
        public List<PbTabInfo> tabInfos { get; set; }
        public Dictionary<string, string> Expressions { get; set; }
        public string TableName { get; set; }

        public int BodyCmpCount { get; set; }   //表体游离panel数量
        public string HasBlobdoc { get; set; }  //是否有金格控件, 0没有，1金格在tab外，2金格在tab内
        public string HasEppocx { get; set; }   //是否有进度控件
