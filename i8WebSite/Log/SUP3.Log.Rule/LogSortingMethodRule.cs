#region Summary
/**************************************************************************************
    * 类 名 称：        LogSortingMethodRule
    * 命名空间：        SUP3.Log.Rule
    * 文 件 名：        LogSortingMethodRule.cs
    * 创建时间：        2017/11/4 
    * 作    者：        洪鹏    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// LogSortingMethod业务逻辑处理类
	/// </summary>
    public partial class LogSortingMethodRule : EntRuleBase<LogSortingMethodModel>, ILogSortingMethodRule
    {
        #region 类变量及属性
		/// <summary>
        /// LogSortingMethod数据访问处理对象
        /// </summary>
        ILogSortingMethodDac LogSortingMethodDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as ILogSortingMethodDac;
            }
        }
        ...
        public override bool DataCheck(IList<LogSortingMethodModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<LogSortingMethodModel> entities, Int64 masterId)
        {
		...
		#region 实现 ILogSortingMethodRule 业务添加的成员
