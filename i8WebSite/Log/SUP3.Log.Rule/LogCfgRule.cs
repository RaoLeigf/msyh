...
namespace SUP3.Log.Rule
{
	...
	/// LogCfg业务逻辑处理类
	/// </summary>
    public partial class LogCfgRule : EntRuleBase<LogCfgModel>, ILogCfgRule
    {
        #region 类变量及属性
		/// <summary>
        /// LogCfg数据访问处理对象
        /// </summary>
        ILogCfgDac LogCfgDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as ILogCfgDac;
            }
        }
        ...
        public override bool DataCheck(IList<LogCfgModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<LogCfgModel> entities, Int64 masterId)
        {
