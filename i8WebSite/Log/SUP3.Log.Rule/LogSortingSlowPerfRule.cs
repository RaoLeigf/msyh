#region Summary
/**************************************************************************************
    * 类 名 称：        LogSortingSlowPerfRule
    * 命名空间：        SUP3.Log.Rule
    * 文 件 名：        LogSortingSlowPerfRule.cs
    * 创建时间：        2017/11/4 
    * 作    者：        洪鹏    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// LogSortingSlowPerf业务逻辑处理类
	/// </summary>
    public partial class LogSortingSlowPerfRule : EntRuleBase<LogSortingSlowPerfModel>, ILogSortingSlowPerfRule
    {
        #region 类变量及属性
		/// <summary>
        /// LogSortingSlowPerf数据访问处理对象
        /// </summary>
        ILogSortingSlowPerfDac LogSortingSlowPerfDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as ILogSortingSlowPerfDac;
            }
        }
        ...
        public override bool DataCheck(IList<LogSortingSlowPerfModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<LogSortingSlowPerfModel> entities, Int64 masterId)
        {
		...
		#region 实现 ILogSortingSlowPerfRule 业务添加的成员
