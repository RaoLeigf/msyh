#region Summary
/**************************************************************************************
    * 类 名 称：        LogOtherCfgRule
    * 命名空间：        SUP3.Log.Rule
    * 文 件 名：        LogOtherCfgRule.cs
    * 创建时间：        2017/10/16 
    * 作    者：        洪鹏    
    * 说    明：        
---------------------------------------------------------------------------------------
...
namespace SUP3.Log.Rule
{
	...
	/// LogOtherCfg业务逻辑处理类
	/// </summary>
    public partial class LogOtherCfgRule : EntRuleBase<LogOtherCfgModel>, ILogOtherCfgRule
    {
        #region 类变量及属性
		/// <summary>
        /// LogOtherCfg数据访问处理对象
        /// </summary>
        ILogOtherCfgDac LogOtherCfgDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as ILogOtherCfgDac;
            }
        }
        ...
        public override bool DataCheck(IList<LogOtherCfgModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<LogOtherCfgModel> entities, Int64 masterId)
        {
		...
		#region 实现 ILogOtherCfgRule 业务添加的成员
