...
namespace SUP3.Log.Rule
{
	...
	/// LogPerf业务逻辑处理类
	/// </summary>
    public partial class LogPerfRule : EntRuleBase<LogPerfModel>, ILogPerfRule
    {
        #region 类变量及属性
		/// <summary>
        /// LogPerf数据访问处理对象
        /// </summary>
        ILogPerfDac LogPerfDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as ILogPerfDac;
            }
        }
        ...
        public override bool DataCheck(IList<LogPerfModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<LogPerfModel> entities, Int64 masterId)
        {
		...
		#region 实现 ILogPerfRule 业务添加的成员
