...
namespace SUP3.Log.Rule
{
	...
	/// LogSql业务逻辑处理类
	/// </summary>
    public partial class LogSqlRule : EntRuleBase<LogSqlModel>, ILogSqlRule
    {
        #region 类变量及属性
		/// <summary>
        /// LogSql数据访问处理对象
        /// </summary>
        ILogSqlDac LogSqlDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as ILogSqlDac;
            }
        }
        ...
        public override bool DataCheck(IList<LogSqlModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<LogSqlModel> entities, Int64 masterId)
        {
