...
namespace SUP3.Log.Rule
{
	...
	/// LogLogs业务逻辑处理类
	/// </summary>
    public partial class LogLogsRule : EntRuleBase<LogLogsModel>, ILogLogsRule
    {
        #region 类变量及属性
		/// <summary>
        /// LogLogs数据访问处理对象
        /// </summary>
        ILogLogsDac LogLogsDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as ILogLogsDac;
            }
        }
        ...
        public override bool DataCheck(IList<LogLogsModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<LogLogsModel> entities, Int64 masterId)
        {
		...
		#region 实现 ILogLogsRule 业务添加的成员
