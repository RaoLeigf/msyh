...
using System.Web;
using System.Data;
using NG3.Bill.Base.WebReference;
using NG3.Bill.Base.WebReference1;
...
namespace NG3.Bill.Base
{
    ...
    {
        private static UploadFileService _UploadFileService
        {
            get
            {
                ...
                try
                {
                    siteUrl = siteUrl.Replace(HttpContext.Current.Request.ServerVariables["SERVER_NAME"], "127.0.0.1") + "/" + NG3.AppInfoBase.Product + NG3.AppInfoBase.Series + "FileSrv/UploadFileService.asmx";
                }
                catch (Exception ex)
                {
                    siteUrl = "http://127.0.0.1:" + HttpContext.Current.Request.Url.Port + "/" + NG3.AppInfoBase.Product + NG3.AppInfoBase.Series + "FileSrv/UploadFileService.asmx";
                }
                //}
        ...
        private static NG3UploadFileSvc _NG3UploadFileSvc
        {
            get
            {
                string siteUrl = string.Empty;
                ...
                try
                {
                    siteUrl = siteUrl.Replace(HttpContext.Current.Request.ServerVariables["SERVER_NAME"], "127.0.0.1") + "/" + NG3.AppInfoBase.Product + NG3.AppInfoBase.Series + "FileSrv/NG3UploadFileSvc.asmx";
                }
                catch (Exception ex)
                {
                    siteUrl = "http://127.0.0.1:" + HttpContext.Current.Request.Url.Port + "/" + NG3.AppInfoBase.Product + NG3.AppInfoBase.Series + "FileSrv/NG3UploadFileSvc.asmx";
                }
                //}
                ...
                //绑定到WebService
                NG3UploadFileSvc service = new NG3UploadFileSvc();
                service.Timeout = 300000;
                service.Url = siteUrl;
        ...
        /// <param name="filename">附件名称按“|”隔开，如111.doc|222.txt</param>        
        /// <returns>删除是否成功(1：成功，其他：错误信息)  </returns>
        public static string DelByFileName(string asr_session_guid, string filename)
        {
            return _UploadFileService.DelByFileName(asr_session_guid, filename);
        }        
        ...
        /// 单据删除时同时删除单据附件数据
        /// </summary>
        /// <param name="orgid">组织phid</param>
        /// <param name="asr_fill">操作员</param>
        /// <param name="asr_code">业务表主键</param>
        /// <param name="asr_table">业务表表名</param>
        /// <param name="asr_attach_table">附件表名称</param>
        /// <param name="asr_dbconn">数据库连接串</param>
        /// <returns></returns>
        public static string DelBillAttach(long orgid, string asr_fill, string asr_code, string asr_table, string asr_attach_table, string asr_dbconn)
        {
            return _UploadFileService.DelBillAttach(orgid, asr_fill, asr_code, asr_table, asr_attach_table, asr_dbconn);
        }
        ...
        /// <returns></returns>
        public static byte[] GetFile(string asr_guid, string asr_fid)
        {
            return _UploadFileService.GetFile(asr_guid, asr_fid);
        }
        ...
        {
            if (string.IsNullOrEmpty(asr_dbconn))
            {
                asr_dbconn = NG3.AppInfoBase.UserConnectString;
            }
        ...
        /// <param name="asr_fillname">录入人姓名</param>
        /// <param name="asr_dbconn">数据库连接串</param>
        /// <param name="bustypecode">业务类型编码</param>
        /// <param name="orgID">组织phid</param>
        /// <param name="busurl">打开业务单据url</param>
        /// <returns></returns>
        public static string Init3(string asr_session_guid, string asr_attach_table, string asr_table, string asr_code, string asr_fill, string asr_fillname, string asr_dbconn, string bustypecode, string orgID, string busurl, string asr_where = "")
        {
            return _UploadFileService.Init3(asr_session_guid, asr_attach_table, asr_table, asr_code, asr_fill, asr_fillname, asr_dbconn, bustypecode, orgID, busurl, asr_where);
        }
        ...
        /// <param name="busurl">打开业务单据url</param>
        /// <returns></returns>
        public static string InitEx3(string asr_session_guid, string asr_attach_table, string asr_table, string asr_code, string asr_fill, string asr_fillname, string asr_dbconn, string bustypecode, string orgID, string busurl)
        {
            return _UploadFileService.InitEx3(asr_session_guid, asr_attach_table, asr_table, asr_code, asr_fill, asr_fillname, asr_dbconn, bustypecode, orgID, busurl);
        }
        ...
        /// <param name="asr_dbconn">数据库连接串</param>
        /// <param name="asr_session_guid_copy">被复制的guid</param>
        /// <param name="asr_fids">需要拷贝的附件asr_fid以逗号隔开</param>
        /// <returns></returns>
        public static string CopyAttachEx(string asr_session_guid, string asr_attach_table, string asr_table, string asr_code, string asr_fill, string asr_fillname, string asr_dbconn, string asr_session_guid_copy, string asr_fids)
        {
            return _UploadFileService.CopyAttachEx(asr_session_guid, asr_attach_table, asr_table, asr_code, asr_fill, asr_fillname, asr_dbconn, asr_session_guid_copy, asr_fids);
        }
        ...
        /// <param name="asr_fids">需要拷贝的附件asr_fid以逗号隔开</param>
        /// <returns></returns>
        public static string CopyAttachByAsrFid(string asr_session_guid, string asr_attach_table, string asr_table, string asr_code, string asr_fill, string asr_fillname, string asr_dbconn, string asr_fids)
        {
            return _UploadFileService.CopyAttachByAsrFid(asr_session_guid, asr_attach_table, asr_table, asr_code, asr_fill, asr_fillname, asr_dbconn, asr_fids);
        }
        ...
        /// <param name="asr_session_guid_copy">被复制的guid</param>
        /// <returns></returns>
        public static string CopyAttachFromBillsEx(string asr_session_guid, string asr_attach_table, string asr_table, string asr_code, string asr_fill, string asr_fillname, string asr_dbconn, string asr_session_guids_copy)
        {
            return _UploadFileService.CopyAttachFromBillsEx(asr_session_guid, asr_attach_table, asr_table, asr_code, asr_fill, asr_fillname, asr_dbconn, asr_session_guids_copy);
        }
        ...
        /// </summary>
        /// <param name="asr_dbconn">数据库连接串</param>
        /// <param name="buffer">附件数据</param>
        /// <returns></returns>
        public static string NG3UploadEx(string asr_dbconn, byte[] buffer)
        {
            if (string.IsNullOrEmpty(asr_dbconn))
            {
                asr_dbconn = NG3.AppInfoBase.UserConnectString;
            ...
            //数据压缩
            var blob_data = NG.UP.Kernel.KernelSerializer.SerializeToBase64(buffer, NG.UP.Kernel.InvokeMemberFlags.Compressed, true);
        ...
        /// <param name="asr_name">文件名称</param>
        /// <param name="asr_fill">上传人id</param>
        /// <param name="asr_fillname">上传人name</param>
        /// <param name="asr_dbconn">数据库连接串</param>
        /// <param name="asr_data">附件数据(二进制格式字符串)</param>
        /// <returns></returns>
        public static string NG3UploadEx2(string asr_code, string asr_table, string asr_attach_table, string asr_name, string asr_fill, string asr_fillname, string asr_dbconn, byte[] buffer)
        {
            if (string.IsNullOrEmpty(asr_dbconn))
            {
                asr_dbconn = NG3.AppInfoBase.UserConnectString;
            ...
            return _NG3UploadFileSvc.NG3UploadEx(asr_code, asr_table, asr_attach_table, asr_name, asr_fill, asr_fillname, asr_dbconn, blob_data);
        }
        ...
        public static string NG3Del(string dbconn, long phid)
        {
            ...
            {
                dbconn = NG3.AppInfoBase.UserConnectString;
            }
        ...
        /// <param name="blob_data"></param>
        /// <returns></returns>
        public static string NG3ModifyEx(string dbconn, long phid, byte[] buffer)
        {
            if (string.IsNullOrEmpty(dbconn))
            {
                dbconn = NG3.AppInfoBase.UserConnectString;
        ...
        /// <param name="phid"></param>
        /// <returns></returns>
        public static string NG3CopyByPhid(string dbconn, long phid)
        {
            return _NG3UploadFileSvc.NG3CopyByPhid(dbconn, phid);
        }
        #endregion
        ...
        /// <returns></returns>
        public static string NG3CopyByAttachIds(string asr_attach_table, string asr_table, string asr_code, string asr_fill, string asr_fillname, string asr_dbconn, string attachids)
        {
        ...
        /// <summary>
        /// 批量附件拷贝，每个附件拷贝到同一业务点的不同目的单据
        /// </summary>
        /// <param name="asr_attach_table">目的单据附件表名</param>
        /// <param name="asr_table">目的单据业务表名</param>
        /// <param name="asr_fill">上传人id</param>
        /// <param name="asr_fillname">上传人姓名</param>
        /// <param name="asr_dbconn">数据库连接串</param>
        /// <param name="phids">单据phid,附件phid|单据phid,附件phid</param>
        /// <returns></returns>
        public static string NG3MutilCopyO2O(string asr_attach_table, string asr_table, string asr_fill, string asr_fillname, string asr_dbconn, string phids)
        {
            return _NG3UploadFileSvc.NG3MutilCopyO2O(asr_attach_table, asr_table, asr_fill, asr_fillname, asr_dbconn, phids);
        }

        /// <summary>
        /// 异步批量附件拷贝，每个附件拷贝到同一业务点的不同目的单据
        /// </summary>
        /// <param name="asr_attach_table">目的单据附件表名</param>
        /// <param name="asr_table">目的单据业务表名</param>
        /// <param name="asr_fill">上传人id</param>
        ...
        /// <param name="phids">单据phid,附件phid|单据phid,附件phid</param>
        /// <returns></returns>
        public static string AyncNG3MutilCopyO2O(string asr_attach_table, string asr_table, string asr_fill, string asr_fillname, string asr_dbconn, string phids)
        {
            return _NG3UploadFileSvc.AyncNG3MutilCopyO2O(asr_attach_table, asr_table, asr_fill, asr_fillname, asr_dbconn, phids);
        }

        /// <summary>
        /// 更新业务单据phid by asr_fid
        /// </summary>
        /// <param name="dbconn"></param>
        /// <param name="asr_code"></param>
        /// <param name="asr_attach_table"></param>
        ...
        /// <returns></returns>
        public static string NG3ModifyAsrCode(string dbconn, string asr_code, string asr_attach_table, string modifyList)
        {
            return _NG3UploadFileSvc.NG3ModifyAsrCode(dbconn, asr_code, asr_attach_table, modifyList);
        }

        /// <summary>
        /// 更新业务单据phid by asr_code
        /// </summary>
        /// <param name="dbconn"></param>
        /// <param name="modifyList"></param>
        /// <returns></returns>
        public static string NG3ModifyAsrCodeEx(string dbconn, string modifyList)
        {
            return _NG3UploadFileSvc.NG3ModifyAsrCodeEx(dbconn, modifyList);
        }
        ...
        /// <param name="asr_table"></param>
        /// <returns></returns>
        public static int NG3AttachCountGet(string dbconn, string asr_code, string asr_table)
        {
            return _NG3UploadFileSvc.NG3AttachCountGet(dbconn, asr_code, asr_table);
        }
        ...
        /// <returns></returns>
        public static DataTable NG3GetAttachInfo(string dbconn, string asr_table, string asr_attach_table, string asr_code)
        {
            return _NG3UploadFileSvc.NG3GetAttachInfo(dbconn, asr_table, asr_attach_table, asr_code);
        }
        ...
        /// <param name="phid">phid</param>
        /// <returns></returns>
        public static DataTable NG3GetAttachInfoByPhid(string dbconn, long phid)
        {
            return _NG3UploadFileSvc.NG3GetAttachInfoByPhid(dbconn, phid);
        }
        ...
        /// <param name="dbconn">数据库连接串</param>
        /// <param name="phid">phid</param>
        /// <param name="asr_code">单据phid用逗号隔开</param>
        /// <returns></returns>
        public static DataTable NG3GetAttachInfoMutil(string dbconn, string asr_table, string asr_attach_table, string asr_code)
        {
            return _NG3UploadFileSvc.NG3GetAttachInfoMutil(dbconn, asr_table, asr_attach_table, asr_code);
        }
        ...
        /// <param name="phid">phid</param>
        /// <returns></returns>
        public static bool NG3MutilDownLoad(string dbconn, string downloadinfo, string destpath)
        {
            return _NG3UploadFileSvc.NG3MutilDownLoad(dbconn, downloadinfo, destpath);
        }

        /// <summary>
        /// 同步附件记录到ngsoft asr_info表
        /// </summary>
        /// <param name="asr_attach_table">附件表名</param>
        /// <param name="asr_table">业务表</param>
        /// <param name="asr_code">业务表主键</param>
        ...
        /// <param name="asr_dbconn">数据库连接串</param>
        /// <returns></returns>
        public static string SyncFileRecord(string asr_session_guid, string asr_attach_table, string asr_table, string asr_code, string asr_fill, string asr_fillname, string asr_dbconn)
        {
            return _NG3UploadFileSvc.SyncFileRecord(asr_session_guid, asr_attach_table, asr_table, asr_code, asr_fill, asr_fillname, asr_dbconn);
        }
        ...
        /// <param name="asr_data">附件数据(二进制格式字符串)</param>
        /// <returns></returns>
        public static string UploadImage(string asr_code, string asr_table, string asr_attach_table, string asr_name, string asr_fill, string asr_fillname, string asr_dbconn, byte[] asr_data)
        {
            return _UploadFileService.UploadImage(asr_code, asr_table, asr_attach_table, asr_name, asr_fill, asr_fillname, asr_dbconn, asr_data);
        }
        ...
        /// <param name="date">日期类别，分为 today,yestoday,earlier</param>
        /// <param name="pictureCount">获取照片数量</param>
        /// <param name="currentNum">当前分类已经获取的照片数量</param>
        /// <param name="userConnection">业务数据库的连接串</param>
        /// <returns>json串</returns>
        public static string GetImageThumbListByDate(string logId, string date, int pictureCount, int currentNum, string dbconn, string asr_table, string asr_attach_table)
        {
            return _UploadFileService.GetImageThumbListByDate(logId, date, pictureCount, currentNum, dbconn, asr_table, asr_attach_table);
        }
    }
}
