...
/**************************************************************************************
    * 命名空间：			GBK3.BK.Rule
    * 类 名 称：			PaymentDtlRule
    * 文 件 名：			PaymentDtlRule.cs
    * 创建时间：			2019/5/15 
    * 作    者：			吾丰明    
    * 说    明：        
---------------------------------------------------------------------------------------
...
namespace GBK3.BK.Rule
{
	...
	/// PaymentDtl业务逻辑处理类
	/// </summary>
    public partial class PaymentDtlRule : EntRuleBase<PaymentDtlModel>, IPaymentDtlRule
    {
        ...
        IPaymentDtlDac PaymentDtlDac
        {
            get
            {
                ...
                return CurrentDac as IPaymentDtlDac;
            }
        }
        #endregion
        ...
        public override bool DataCheck(IList<PaymentDtlModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<PaymentDtlModel> entities, Int64 masterId)
        {
