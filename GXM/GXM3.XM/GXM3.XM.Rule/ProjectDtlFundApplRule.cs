#region Summary
/**************************************************************************************
    * 类 名 称：        ProjectDtlFundApplRule
    * 命名空间：        GXM3.XM.Rule
    * 文 件 名：        ProjectDtlFundApplRule.cs
    * 创建时间：        2018/8/28 
    * 作    者：        李明    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// ProjectDtlFundAppl业务逻辑处理类
	/// </summary>
    public partial class ProjectDtlFundApplRule : EntRuleBase<ProjectDtlFundApplModel>, IProjectDtlFundApplRule
    {
        #region 类变量及属性
		/// <summary>
        /// ProjectDtlFundAppl数据访问处理对象
        /// </summary>
        IProjectDtlFundApplDac ProjectDtlFundApplDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IProjectDtlFundApplDac;
            }
        }
        ...
        public override bool DataCheck(IList<ProjectDtlFundApplModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<ProjectDtlFundApplModel> entities, Int64 masterId)
        {
		...
		#region 实现 IProjectDtlFundApplRule 业务添加的成员
