...
namespace GXM3.XM.Rule
{
	...
	/// XmReportDtl业务逻辑处理类
	/// </summary>
    public partial class XmReportDtlRule : EntRuleBase<XmReportDtlModel>, IXmReportDtlRule
    {
        #region 类变量及属性
		/// <summary>
        /// XmReportDtl数据访问处理对象
        /// </summary>
        IXmReportDtlDac XmReportDtlDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IXmReportDtlDac;
            }
        }
        #endregion
        ...
        public override bool DataCheck(IList<XmReportDtlModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<XmReportDtlModel> entities, Int64 masterId)
        {
		...
		#region 实现 IXmReportDtlRule 业务添加的成员
