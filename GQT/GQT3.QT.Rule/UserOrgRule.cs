...
namespace GQT3.QT.Rule
{
	...
	/// UserOrg业务逻辑处理类
	/// </summary>
    public partial class UserOrgRule : EntRuleBase<UserOrganize2Model>, IUserOrgRule
    {
        #region 类变量及属性
		/// <summary>
        /// UserOrg数据访问处理对象
        /// </summary>
        IUserOrgDac UserOrgDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IUserOrgDac;
            }
        }
        ...
        public override bool DataCheck(IList<UserOrganize2Model> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<UserOrganize2Model> entities, Int64 masterId)
        {
		...
		#region 实现 IUserOrgRule 业务添加的成员
