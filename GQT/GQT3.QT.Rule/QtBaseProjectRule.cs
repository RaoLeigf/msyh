#region Summary
/**************************************************************************************
    * 类 名 称：        QtBaseProjectRule
    * 命名空间：        GQT3.QT.Rule
    * 文 件 名：        QtBaseProjectRule.cs
    * 创建时间：        2018/11/23 
    * 作    者：        刘杭    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// QtBaseProject业务逻辑处理类
	/// </summary>
    public partial class QtBaseProjectRule : EntRuleBase<QtBaseProjectModel>, IQtBaseProjectRule
    {
        #region 类变量及属性
		/// <summary>
        /// QtBaseProject数据访问处理对象
        /// </summary>
        IQtBaseProjectDac QtBaseProjectDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IQtBaseProjectDac;
            }
        }
        ...
        public override bool DataCheck(IList<QtBaseProjectModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<QtBaseProjectModel> entities, Int64 masterId)
        {
		...
		#region 实现 IQtBaseProjectRule 业务添加的成员
