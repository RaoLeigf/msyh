...
namespace GQT3.QT.Rule
{
	...
	/// QtOrgDygx业务逻辑处理类
	/// </summary>
    public partial class QtOrgDygxRule : EntRuleBase<QtOrgDygxModel>, IQtOrgDygxRule
    {
        #region 类变量及属性
		/// <summary>
        /// QtOrgDygx数据访问处理对象
        /// </summary>
        IQtOrgDygxDac QtOrgDygxDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IQtOrgDygxDac;
            }
        }
       ...
       // protected override string BillNoIdentity { get; set; }
        ...
        public override bool DataCheck(IList<QtOrgDygxModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<QtOrgDygxModel> entities, Int64 masterId)
        {
        ...
        #region 实现 IQtOrgDygxRule 业务添加的成员
        ...
        /// <returns></returns>
        public IList<QtOrgDygxModel> findByXmorg(string Xmorg)
        {
            Dictionary<string, object> dicWhere = new Dictionary<string, object>();
            new CreateCriteria(dicWhere)
                .Add(ORMRestrictions<String>.Eq("Xmorg", Xmorg));
            IList<QtOrgDygxModel> OrgDygx = QtOrgDygxDac.Find(dicWhere);
            return OrgDygx;
        }
        ...
        /// <returns></returns>
        public IList<QtOrgDygxModel> findByOldorg(string Oldorg)
        {
            Dictionary<string, object> dicWhere = new Dictionary<string, object>();
            new CreateCriteria(dicWhere)
                .Add(ORMRestrictions<String>.Eq("Oldorg", Oldorg));
            IList<QtOrgDygxModel> OrgDygx = QtOrgDygxDac.Find(dicWhere);
            return OrgDygx;
        }
        #endregion
