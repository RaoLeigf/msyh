...
namespace GQT3.QT.Rule
{
	...
	/// QtZcgnfl业务逻辑处理类
	/// </summary>
    public partial class QtZcgnflRule : EntRuleBase<QtZcgnflModel>, IQtZcgnflRule
    {
        #region 类变量及属性
		/// <summary>
        /// QtZcgnfl数据访问处理对象
        /// </summary>
        IQtZcgnflDac QtZcgnflDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IQtZcgnflDac;
            }
        }
        ...
        public override bool DataCheck(IList<QtZcgnflModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<QtZcgnflModel> entities, Int64 masterId)
        {
		...
		#region 实现 IQtZcgnflRule 业务添加的成员
