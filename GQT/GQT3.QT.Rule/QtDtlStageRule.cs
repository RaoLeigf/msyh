...
/**************************************************************************************
    * 命名空间：			GQT3.QT.Rule
    * 类 名 称：			QtDtlStageRule
    * 文 件 名：			QtDtlStageRule.cs
    * 创建时间：			2019/9/4 
    * 作    者：			刘杭    
    * 说    明：        
---------------------------------------------------------------------------------------
...
namespace GQT3.QT.Rule
{
	...
	/// QtDtlStage业务逻辑处理类
	/// </summary>
    public partial class QtDtlStageRule : EntRuleBase<QtDtlStageModel>, IQtDtlStageRule
    {
        #region 类变量及属性
		/// <summary>
        /// QtDtlStage数据访问处理对象
        /// </summary>
        IQtDtlStageDac QtDtlStageDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IQtDtlStageDac;
            }
        }
        #endregion
        ...
        public override bool DataCheck(IList<QtDtlStageModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<QtDtlStageModel> entities, Int64 masterId)
        {
		...
		#region 实现 IQtDtlStageRule 业务添加的成员
