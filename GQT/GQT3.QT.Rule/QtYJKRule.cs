...
namespace GQT3.QT.Rule
{
	...
	/// QtYJK业务逻辑处理类
	/// </summary>
    public partial class QtYJKRule : EntRuleBase<QtYJKModel>, IQtYJKRule
    {
        #region 类变量及属性
		/// <summary>
        /// QtYJK数据访问处理对象
        ...
        IQtYJKDac QtYJKDac
        {
            get
            {
                ...
                return CurrentDac as IQtYJKDac;
            }
        }
        #endregion
        ...
        public override bool DataCheck(IList<QtYJKModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<QtYJKModel> entities, Int64 masterId)
        {
