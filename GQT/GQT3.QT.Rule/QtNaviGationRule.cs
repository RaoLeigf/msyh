...
/**************************************************************************************
    * 命名空间：			GQT3.QT.Rule
    * 类 名 称：			QtNaviGationRule
    * 文 件 名：			QtNaviGationRule.cs
    * 创建时间：			2019/11/14 
    * 作    者：			张宇    
    * 说    明：        
---------------------------------------------------------------------------------------
...
namespace GQT3.QT.Rule
{
	...
	/// QtNaviGation业务逻辑处理类
	/// </summary>
    public partial class QtNaviGationRule : EntRuleBase<QtNaviGationModel>, IQtNaviGationRule
    {
        #region 类变量及属性
		/// <summary>
        /// QtNaviGation数据访问处理对象
        /// </summary>
        IQtNaviGationDac QtNaviGationDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IQtNaviGationDac;
            }
        }
        #endregion
        ...
        public override bool DataCheck(IList<QtNaviGationModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<QtNaviGationModel> entities, Int64 masterId)
        {
		...
		#region 实现 IQtNaviGationRule 业务添加的成员
