...
namespace GQT3.QT.Rule
{
	...
	/// User业务逻辑处理类
	/// </summary>
    public partial class UserRule : EntRuleBase<User2Model>, IUserRule
    {
        #region 类变量及属性
		/// <summary>
        /// User数据访问处理对象
        ...
        public override bool DataCheck(IList<User2Model> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<User2Model> entities, Int64 masterId)
        {
