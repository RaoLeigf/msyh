...
namespace GQT3.QT.Rule
{
	...
	/// QTMemo业务逻辑处理类
	/// </summary>
    public partial class QTMemoRule : EntRuleBase<QTMemoModel>, IQTMemoRule
    {
        #region 类变量及属性
		/// <summary>
        /// QTMemo数据访问处理对象
        /// </summary>
        IQTMemoDac QTMemoDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IQTMemoDac;
            }
        }
        #endregion
        ...
        public override bool DataCheck(IList<QTMemoModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<QTMemoModel> entities, Int64 masterId)
        {
