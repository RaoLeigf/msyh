...
namespace GQT3.QT.Rule
{
	...
	/// QTProduct业务逻辑处理类
	/// </summary>
    public partial class QTProductRule : EntRuleBase<QTProductModel>, IQTProductRule
    {
        #region 类变量及属性
		/// <summary>
        /// QTProduct数据访问处理对象
        /// </summary>
        IQTProductDac QTProductDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IQTProductDac;
            }
        }
  ...
  //      protected override string BillNoIdentity { get; set; }
        ...
        public override bool DataCheck(IList<QTProductModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<QTProductModel> entities, Int64 masterId)
        {
		...
		#region 实现 IQTProductRule 业务添加的成员
