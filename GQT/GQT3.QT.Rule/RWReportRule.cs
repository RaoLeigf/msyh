...
namespace GQT3.QT.Rule
{
	...
	/// RWReport业务逻辑处理类
	/// </summary>
    public partial class RWReportRule : EntRuleBase<RWReportModel>, IRWReportRule
    {
        #region 类变量及属性
		/// <summary>
        /// RWReport数据访问处理对象
        /// </summary>
        IRWReportDac RWReportDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IRWReportDac;
            }
        }
        ...
        public override bool DataCheck(IList<RWReportModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<RWReportModel> entities, Int64 masterId)
        {
		...
		#region 实现 IRWReportRule 业务添加的成员
