#region Summary
/**************************************************************************************
    * 类 名 称：        PaymentMethodRule
    * 命名空间：        GQT3.QT.Rule
    * 文 件 名：        PaymentMethodRule.cs
    * 创建时间：        2018/9/7 
    * 作    者：        夏华军    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// PaymentMethod业务逻辑处理类
	/// </summary>
    public partial class PaymentMethodRule : EntRuleBase<PaymentMethodModel>, IPaymentMethodRule
    {
        #region 类变量及属性
		/// <summary>
        /// PaymentMethod数据访问处理对象
        /// </summary>
        IPaymentMethodDac PaymentMethodDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IPaymentMethodDac;
            }
        }
        ...
        public override bool DataCheck(IList<PaymentMethodModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<PaymentMethodModel> entities, Int64 masterId)
        {
		...
		#region 实现 IPaymentMethodRule 业务添加的成员
