#region Summary
/**************************************************************************************
    * 类 名 称：        PerformEvalTargetClassModel
    * 命名空间：        GQT3.QT.Model.Domain
    * 文 件 名：        PerformEvalTargetClassModel.cs
    * 创建时间：        2018/10/16 
    * 作    者：        刘杭    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
    /// <summary>
    /// PerformEvalTargetClass实体定义类
    /// </summary>
    [Serializable]
	[DataContract(Namespace = "")]
    public partial class PerformEvalTargetClassModel : EntityBase<PerformEvalTargetClassModel>
    {
		/// <summary>
		/// 主键
		/// </summary>
