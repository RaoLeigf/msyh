#region Summary
/**************************************************************************************
    * 类 名 称：        ProcurementCatalogModel
    * 命名空间：        GQT3.QT.Model.Domain
    * 文 件 名：        ProcurementCatalogModel.cs
    * 创建时间：        2018/10/16 
    * 作    者：        李长敏琛    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
    /// <summary>
    /// ProcurementCatalog实体定义类
    /// </summary>
    [Serializable]
	[DataContract(Namespace = "")]
    public partial class ProcurementCatalogModel : EntityBase<ProcurementCatalogModel>
    {
		/// <summary>
		/// 主键
		/// </summary>
