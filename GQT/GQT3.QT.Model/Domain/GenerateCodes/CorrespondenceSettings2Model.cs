#region Summary
/**************************************************************************************
    * 类 名 称：        CorrespondenceSettings2Model
    * 命名空间：        GQT3.QT.Model.Domain
    * 文 件 名：        CorrespondenceSettings2Model.cs
    * 创建时间：        2018/9/6 
    * 作    者：        刘杭    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
    /// <summary>
    /// CorrespondenceSettings2实体定义类
    /// </summary>
    [Serializable]
	[DataContract(Namespace = "")]
    public partial class CorrespondenceSettings2Model : EntityBase<CorrespondenceSettings2Model>
    {
		/// <summary>
		/// 主键
		/// </summary>
