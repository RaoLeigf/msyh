...
/**************************************************************************************
    * 命名空间：			GGK3.GK.Rule
    * 类 名 称：			GKPaymentMstRule
    * 文 件 名：			GKPaymentMstRule.cs
    * 创建时间：			2019/5/20 
    * 作    者：			李明    
    * 说    明：        
---------------------------------------------------------------------------------------
...
namespace GGK3.GK.Rule
{
	...
	/// GKPaymentMst业务逻辑处理类
	/// </summary>
    public partial class GKPaymentMstRule : EntRuleBase<GKPaymentMstModel>, IGKPaymentMstRule
    {
        //protected override string BillNoIdentity { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        #region 类变量及属性
        /// <summary>
        /// GKPaymentMst数据访问处理对象
        /// </summary>
        IGKPaymentMstDac GKPaymentMstDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IGKPaymentMstDac;
            }
        }
        #endregion
        ...
        public override bool DataCheck(IList<GKPaymentMstModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<GKPaymentMstModel> entities, Int64 masterId)
        {
		...
		#region 实现 IGKPaymentMstRule 业务添加的成员

		///// <summary>
        ///// 方法实例
        ///// </summary>
        ///// <returns></returns>
        //public IList<GKPaymentMstModel> ExampleMethod<GKPaymentMstModel>(string param)
        //{
        //    //编写代码
        //}
