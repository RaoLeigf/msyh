#region Summary
/**************************************************************************************
    * 类 名 称：        PerformanceDtlEvalRule
    * 命名空间：        GJX3.JX.Rule
    * 文 件 名：        PerformanceDtlEvalRule.cs
    * 创建时间：        2018/9/12 
    * 作    者：        吾丰明    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// PerformanceDtlEval业务逻辑处理类
	/// </summary>
    public partial class PerformanceDtlEvalRule : EntRuleBase<PerformanceDtlEvalModel>, IPerformanceDtlEvalRule
    {
        #region 类变量及属性
		/// <summary>
        /// PerformanceDtlEval数据访问处理对象
        /// </summary>
        IPerformanceDtlEvalDac PerformanceDtlEvalDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IPerformanceDtlEvalDac;
            }
        }
        ...
        public override bool DataCheck(IList<PerformanceDtlEvalModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<PerformanceDtlEvalModel> entities, Int64 masterId)
        {
		...
		#region 实现 IPerformanceDtlEvalRule 业务添加的成员
