#region Summary
/**************************************************************************************
    * 类 名 称：        PerformanceDtlBuDtlRule
    * 命名空间：        GJX3.JX.Rule
    * 文 件 名：        PerformanceDtlBuDtlRule.cs
    * 创建时间：        2018/9/12 
    * 作    者：        吾丰明    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// PerformanceDtlBuDtl业务逻辑处理类
	/// </summary>
    public partial class PerformanceDtlBuDtlRule : EntRuleBase<PerformanceDtlBuDtlModel>, IPerformanceDtlBuDtlRule
    {
        #region 类变量及属性
		/// <summary>
        /// PerformanceDtlBuDtl数据访问处理对象
        /// </summary>
        IPerformanceDtlBuDtlDac PerformanceDtlBuDtlDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IPerformanceDtlBuDtlDac;
            }
        }
        ...
        public override bool DataCheck(IList<PerformanceDtlBuDtlModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<PerformanceDtlBuDtlModel> entities, Int64 masterId)
        {
		...
		#region 实现 IPerformanceDtlBuDtlRule 业务添加的成员
