#region Summary
/**************************************************************************************
    * 类 名 称：        PerformanceMstRule
    * 命名空间：        GJX3.JX.Rule
    * 文 件 名：        PerformanceMstRule.cs
    * 创建时间：        2018/9/12 
    * 作    者：        吾丰明    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// PerformanceMst业务逻辑处理类
	/// </summary>
    public partial class PerformanceMstRule : EntRuleBase<PerformanceMstModel>, IPerformanceMstRule
    {
        #region 类变量及属性
		/// <summary>
        /// PerformanceMst数据访问处理对象
        /// </summary>
        IPerformanceMstDac PerformanceMstDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IPerformanceMstDac;
            }
        }
        ...
        public override bool DataCheck(IList<PerformanceMstModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<PerformanceMstModel> entities, Int64 masterId)
        {
		...
		#region 实现 IPerformanceMstRule 业务添加的成员
