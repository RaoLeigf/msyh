...
namespace GYS3.YS.Rule
{
	...
	/// ExpenseHx业务逻辑处理类
	/// </summary>
    public partial class ExpenseHxRule : EntRuleBase<ExpenseHxModel>, IExpenseHxRule
    {
        #region 类变量及属性
		/// <summary>
        /// ExpenseHx数据访问处理对象
        /// </summary>
        IExpenseHxDac ExpenseHxDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IExpenseHxDac;
            }
        }
        #endregion
        ...
        public override bool DataCheck(IList<ExpenseHxModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<ExpenseHxModel> entities, Int64 masterId)
        {
		...
		#region 实现 IExpenseHxRule 业务添加的成员
