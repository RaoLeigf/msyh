#region Summary
/**************************************************************************************
    * 类 名 称：        ExpenseMstRule
    * 命名空间：        GYS3.YS.Rule
    * 文 件 名：        ExpenseMstRule.cs
    * 创建时间：        2019/1/24 
    * 作    者：        董泉伟    
    * 说    明：        
---------------------------------------------------------------------------------------
...
namespace GYS3.YS.Rule
{
	...
	/// ExpenseMst业务逻辑处理类
	/// </summary>
    public partial class ExpenseMstRule : EntRuleBase<ExpenseMstModel>, IExpenseMstRule
    {
        #region 类变量及属性
		/// <summary>
        /// ExpenseMst数据访问处理对象
        /// </summary>
        IExpenseMstDac ExpenseMstDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IExpenseMstDac;
            }
        }
        ...
        public override bool DataCheck(IList<ExpenseMstModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<ExpenseMstModel> entities, Int64 masterId)
        {
		...
		#region 实现 IExpenseMstRule 业务添加的成员
