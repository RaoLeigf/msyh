#region Summary
/**************************************************************************************
    * 类 名 称：        BudgetDtlPurDtl4SOFRule
    * 命名空间：        GYS3.YS.Rule
    * 文 件 名：        BudgetDtlPurDtl4SOFRule.cs
    * 创建时间：        2018/10/22 
    * 作    者：        刘杭    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// BudgetDtlPurDtl4SOF业务逻辑处理类
	/// </summary>
    public partial class BudgetDtlPurDtl4SOFRule : EntRuleBase<BudgetDtlPurDtl4SOFModel>, IBudgetDtlPurDtl4SOFRule
    {
        #region 类变量及属性
		/// <summary>
        /// BudgetDtlPurDtl4SOF数据访问处理对象
        /// </summary>
        IBudgetDtlPurDtl4SOFDac BudgetDtlPurDtl4SOFDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IBudgetDtlPurDtl4SOFDac;
            }
        }
        ...
        public override bool DataCheck(IList<BudgetDtlPurDtl4SOFModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<BudgetDtlPurDtl4SOFModel> entities, Int64 masterId)
        {
		...
		#region 实现 IBudgetDtlPurDtl4SOFRule 业务添加的成员
