#region Summary
/**************************************************************************************
    * 类 名 称：        BudgetDtlImplPlanRule
    * 命名空间：        GYS3.YS.Rule
    * 文 件 名：        BudgetDtlImplPlanRule.cs
    * 创建时间：        2018/8/30 
    * 作    者：        董泉伟    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// BudgetDtlImplPlan业务逻辑处理类
	/// </summary>
    public partial class BudgetDtlImplPlanRule : EntRuleBase<BudgetDtlImplPlanModel>, IBudgetDtlImplPlanRule
    {
        #region 类变量及属性
		/// <summary>
        /// BudgetDtlImplPlan数据访问处理对象
        /// </summary>
        IBudgetDtlImplPlanDac BudgetDtlImplPlanDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IBudgetDtlImplPlanDac;
            }
        }
        ...
        public override bool DataCheck(IList<BudgetDtlImplPlanModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<BudgetDtlImplPlanModel> entities, Int64 masterId)
        {
        ...
        #region 实现 IBudgetDtlImplPlanRule 业务添加的成员
