#region Summary
/**************************************************************************************
    * 类 名 称：        SubjectMstBudgetDtlRule
    * 命名空间：        GYS3.YS.Rule
    * 文 件 名：        SubjectMstBudgetDtlRule.cs
    * 创建时间：        2018/11/26 
    * 作    者：        董泉伟    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
    /// <summary>
    /// SubjectMstBudgetDtl业务逻辑处理类
    /// </summary>
    public partial class SubjectMstBudgetDtlRule : EntRuleBase<SubjectMstBudgetDtlModel>, ISubjectMstBudgetDtlRule
    {
        #region 类变量及属性
        /// <summary>
        /// SubjectMstBudgetDtl数据访问处理对象
        /// </summary>
        ISubjectMstBudgetDtlDac SubjectMstBudgetDtlDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as ISubjectMstBudgetDtlDac;
            }
        }
        ...
        public override bool DataCheck(IList<SubjectMstBudgetDtlModel> entities, out string prompt)
        {
            prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<SubjectMstBudgetDtlModel> entities, Int64 masterId)
        {
        ...
        #region 实现 ISubjectMstBudgetDtlRule 业务添加的成员
