...
/**************************************************************************************
    * 命名空间：			GYS3.YS.Rule
    * 类 名 称：			BudgetDtlPersonnelRule
    * 文 件 名：			BudgetDtlPersonnelRule.cs
    * 创建时间：			2020/1/2 
    * 作    者：			王冠冠    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// BudgetDtlPersonnel业务逻辑处理类
	/// </summary>
    public partial class BudgetDtlPersonnelRule : EntRuleBase<BudgetDtlPersonnelModel>, IBudgetDtlPersonnelRule
    {
        #region 类变量及属性
		/// <summary>
        /// BudgetDtlPersonnel数据访问处理对象
        /// </summary>
        IBudgetDtlPersonnelDac BudgetDtlPersonnelDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IBudgetDtlPersonnelDac;
            }
        }
        #endregion
        ...
        public override bool DataCheck(IList<BudgetDtlPersonnelModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<BudgetDtlPersonnelModel> entities, Int64 masterId)
        {
		...
		#region 实现 IBudgetDtlPersonnelRule 业务添加的成员
