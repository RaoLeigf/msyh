#region Summary
/**************************************************************************************
    * 类 名 称：        SubjectMstRule
    * 命名空间：        GYS3.YS.Rule
    * 文 件 名：        SubjectMstRule.cs
    * 创建时间：        2018/11/26 
    * 作    者：        董泉伟    
    * 说    明：        
---------------------------------------------------------------------------------------
...
namespace GYS3.YS.Rule
{
    ...
    /// SubjectMst业务逻辑处理类
    /// </summary>
    public partial class SubjectMstRule : EntRuleBase<SubjectMstModel>, ISubjectMstRule
    {
        #region 类变量及属性
        /// <summary>
        /// SubjectMst数据访问处理对象
        /// </summary>
        ISubjectMstDac SubjectMstDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as ISubjectMstDac;
            }
        }
        ...
        public override bool DataCheck(IList<SubjectMstModel> entities, out string prompt)
        {
            prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<SubjectMstModel> entities, Int64 masterId)
        {
        ...
        #region 实现 ISubjectMstRule 业务添加的成员
