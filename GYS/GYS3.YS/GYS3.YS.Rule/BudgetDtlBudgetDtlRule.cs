#region Summary
/**************************************************************************************
    * 类 名 称：        BudgetDtlBudgetDtlRule
    * 命名空间：        GYS3.YS.Rule
    * 文 件 名：        BudgetDtlBudgetDtlRule.cs
    * 创建时间：        2018/8/30 
    * 作    者：        董泉伟    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// BudgetDtlBudgetDtl业务逻辑处理类
	/// </summary>
    public partial class BudgetDtlBudgetDtlRule : EntRuleBase<BudgetDtlBudgetDtlModel>, IBudgetDtlBudgetDtlRule
    {
        #region 类变量及属性
		/// <summary>
        /// BudgetDtlBudgetDtl数据访问处理对象
        /// </summary>
        IBudgetDtlBudgetDtlDac BudgetDtlBudgetDtlDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IBudgetDtlBudgetDtlDac;
            }
        }
        ...
        public override bool DataCheck(IList<BudgetDtlBudgetDtlModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<BudgetDtlBudgetDtlModel> entities, Int64 masterId)
        {
		...
		#region 实现 IBudgetDtlBudgetDtlRule 业务添加的成员
