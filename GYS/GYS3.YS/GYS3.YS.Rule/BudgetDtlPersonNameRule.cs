...
/**************************************************************************************
    * 命名空间：			GYS3.YS.Rule
    * 类 名 称：			BudgetDtlPersonNameRule
    * 文 件 名：			BudgetDtlPersonNameRule.cs
    * 创建时间：			2020/1/14 
    * 作    者：			王冠冠    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
	/// <summary>
	/// BudgetDtlPersonName业务逻辑处理类
	/// </summary>
    public partial class BudgetDtlPersonNameRule : EntRuleBase<BudgetDtlPersonNameModel>, IBudgetDtlPersonNameRule
    {
        #region 类变量及属性
		/// <summary>
        /// BudgetDtlPersonName数据访问处理对象
        /// </summary>
        IBudgetDtlPersonNameDac BudgetDtlPersonNameDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IBudgetDtlPersonNameDac;
            }
        }
        #endregion
        ...
        public override bool DataCheck(IList<BudgetDtlPersonNameModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<BudgetDtlPersonNameModel> entities, Int64 masterId)
        {
		...
		#region 实现 IBudgetDtlPersonNameRule 业务添加的成员
