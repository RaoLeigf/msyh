...
namespace GYS3.YS.Rule
{
	...
	/// </summary>
    public partial class BuDeptReportRule : EntRuleBase<BuDeptReportModel>, IBuDeptReportRule
    {
        #region 类变量及属性
        /// <summary>
        /// BudgetDtlBudgetDtl数据访问处理对象
        /// </summary>
        IBuDeptReportDac BudgetDtlBudgetDtlDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IBuDeptReportDac;
            }
        }
        ...
        public override bool DataCheck(IList<BuDeptReportModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<BuDeptReportModel> entities, Int64 masterId)
        {
        ...
        #region 实现 IBuDeptReportModelRule 业务添加的成员
