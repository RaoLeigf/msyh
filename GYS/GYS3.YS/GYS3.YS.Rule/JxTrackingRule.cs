...
/**************************************************************************************
    * 命名空间：			GYS3.YS.Rule
    * 类 名 称：			JxTrackingRule
    * 文 件 名：			JxTrackingRule.cs
    * 创建时间：			2019/10/17 
    * 作    者：			刘杭    
    * 说    明：        
---------------------------------------------------------------------------------------
...
namespace GYS3.YS.Rule
{
	...
	/// JxTracking业务逻辑处理类
	/// </summary>
    public partial class JxTrackingRule : EntRuleBase<JxTrackingModel>, IJxTrackingRule
    {
        #region 类变量及属性
		/// <summary>
        /// JxTracking数据访问处理对象
        /// </summary>
        IJxTrackingDac JxTrackingDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IJxTrackingDac;
            }
        }
        #endregion
        ...
        public override bool DataCheck(IList<JxTrackingModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<JxTrackingModel> entities, Int64 masterId)
        {
		...
		#region 实现 IJxTrackingRule 业务添加的成员
