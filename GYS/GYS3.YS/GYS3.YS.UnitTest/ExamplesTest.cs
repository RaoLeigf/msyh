...
/**************************************************************************************
    * 类 名 称：        ExamplesTest
    * 命名空间：        GYS3.YS.UnitTest
    * 文 件 名：        ExamplesTest.cs
    * 创建时间：        2018/8/17 9:53:14 
    * 作    者：        丰立新    
    * 说    明：        
---------------------------------------------------------------------------------------
    * 修改时间：        * 修改人：        *说明：
    ...
    public class ExamplesTest : AbstractTransactionalDbProviderSpringContextTests
    {
        ...
        protected IExamplesService ExamplesService
        {
            get
            {
                ...
                return applicationContext.GetObject<IExamplesService>("GYS3.YS.UnitTest.Service.ExamplesService");
            }
        }
