#region Summary
/**************************************************************************************
    * 类 名 称：        BudgetDtlPurDtl4SOFModel
    * 命名空间：        GYS3.YS.Model.Domain
    * 文 件 名：        BudgetDtlPurDtl4SOFModel.cs
    * 创建时间：        2018/10/22 
    * 作    者：        刘杭    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
    /// <summary>
    /// BudgetDtlPurDtl4SOF实体定义类
    /// </summary>
    [Serializable]
	[DataContract(Namespace = "")]
    public partial class BudgetDtlPurDtl4SOFModel : EntityBase<BudgetDtlPurDtl4SOFModel>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public BudgetDtlPurDtl4SOFModel()
        {
