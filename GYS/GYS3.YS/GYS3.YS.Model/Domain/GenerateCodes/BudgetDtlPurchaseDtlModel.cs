#region Summary
/**************************************************************************************
    * 类 名 称：        BudgetDtlPurchaseDtlModel
    * 命名空间：        GYS3.YS.Model.Domain
    * 文 件 名：        BudgetDtlPurchaseDtlModel.cs
    * 创建时间：        2018/10/22 
    * 作    者：        刘杭    
    * 说    明：        
---------------------------------------------------------------------------------------
...
//using GXM3.XM.Model.Domain.GenerateCodes;

namespace GYS3.YS.Model.Domain
{
    /// <summary>
    /// BudgetDtlPurchaseDtl实体定义类
    /// </summary>
    [Serializable]
	[DataContract(Namespace = "")]
    public partial class BudgetDtlPurchaseDtlModel : EntityBase<BudgetDtlPurchaseDtlModel>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public BudgetDtlPurchaseDtlModel()
        {
