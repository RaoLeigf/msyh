#region Summary
/**************************************************************************************
    * 类 名 称：        BudgetDtlPersonnelModel
    * 命名空间：        GYS3.YS.Model.Domain
    * 文 件 名：        BudgetDtlPersonnelModel.cs
    * 创建时间：        2020/1/2 
    * 作    者：        王冠冠    
    * 说    明：        
---------------------------------------------------------------------------------------
...
{
    /// <summary>
    /// BudgetDtlPersonnel实体定义类
    /// </summary>
    [Serializable]
	[DataContract(Namespace = "")]
    public partial class BudgetDtlPersonnelModel : EntityBase<BudgetDtlPersonnelModel>
    {
		/// <summary>
		/// 构造函数
		/// </summary>
		public BudgetDtlPersonnelModel()
		{
