...
namespace GYS3.YS.Facade.Interface
{
	...
	/// </summary>
    public partial interface IBuDeptReportFacade : IEntFacadeBase<BuDeptReportModel>
    {
        ///// <summary>
        ///// 预算科目删除时查找是否引用
        ///// </summary>
        ...
        ///// <returns></returns>
        //FindedResults<BuDeptReportModel> FindByCode(Dictionary<string, object> dicWhere);
