...
namespace Enterprise3.WebApi.GWF3.WF.Controller
{
    ...
    public class DCHelper
    {
        ...
        public static String ModelListToJson(DataTable dt, Int64 count, Int64 pageindex, Int64 pagesize)
        {
            return "{\"totalRows\":" + count + ",\"Record\":" + JsonConvert.SerializeObject(dt) + ",\"index\":" + pageindex + ",\"size\":" + pagesize + "}";
        }
