...
/**************************************************************************************
    * 命名空间：			GSP3.SP.Rule
    * 类 名 称：			GAppvalPostRule
    * 文 件 名：			GAppvalPostRule.cs
    * 创建时间：			2019/5/20 
    * 作    者：			李明    
    * 说    明：        
---------------------------------------------------------------------------------------
...
namespace GSP3.SP.Rule
{
	...
	/// GAppvalPost业务逻辑处理类
	/// </summary>
    public partial class GAppvalPostRule : EntRuleBase<GAppvalPostModel>, IGAppvalPostRule
    {
        ...
        /// GAppvalPost数据访问处理对象
        /// </summary>
        IGAppvalPostDac GAppvalPostDac
        {
            get
            {
                if (CurrentDac == null)
                ...
                return CurrentDac as IGAppvalPostDac;
            }
        }
        #endregion
        ...
        public override bool DataCheck(IList<GAppvalPostModel> entities, out string prompt)
        {
			prompt = null;
            return true;
        }
        ...
        public override void DataHandling<Int64>(ref IList<GAppvalPostModel> entities, Int64 masterId)
        {
        ...
        #region 实现 IGAppvalPostRule 业务添加的成员

        ///// <summary>
        ///// 方法实例
        ///// </summary>
        ///// <returns></returns>
        //public IList<GAppvalPostModel> ExampleMethod<GAppvalPostModel>(string param)
        //{
        //    //编写代码
        //}
